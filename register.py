...
class Register:
    def __init__(self, root):
        ...
        scritqustn_drpdwn['values']= ("Select---", "Your Mother's Maiden Name", "Your Home Town", "Your Bestfriend")
    ...
    def register_data(self):
        if self.Fname_ntr.get()=="" or self.Sname_ntr.get()=="" or self.contctdtls_ntr.get()=="" or self.email_ntr.get()=="" or self.ans_ntr.get()=="" or self.paswrd_ntr.get()=="" or self.confrmpaswrd_ntr.get()=="" or self.scritqustn_drpdwn.get()==0:
            ...
            if row!= None:
                ...
                crsr.execute("insert into users (f_name, s_name, contct_num, email, scrit_qustn, answer, confrm_paswrd)",
                                (self.Fname_ntr.get(),
                                 self.Sname_ntr.get(),
                                 self.contctdtls_ntr.get(),
                                 self.email.get(),
                                 self.scritqustn_drpdwn.get(),
                                 self.ans_ntr.get(),
